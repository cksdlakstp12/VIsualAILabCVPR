...
from model import SSD300ReturnFeatures, MultiBoxLoss, BoxLoss
...
def softTeaching_every_batch(s_model: SSD300,
    ...
    # Batches
    for (batch_idx, (wL_image_vis, wL_image_lwir, sL_image_vis, sL_image_lwir, L_boxes, L_labels, L_is_anno, L_cluster_id)), \
        (        _, (wU_image_vis, wU_image_lwir, sU_image_vis, sU_image_lwir, U_boxes, U_labels, U_is_anno, U_cluster_id)) \
        ...
        sup_loss, sup_cls_loss, sup_loc_loss, sup_n_positives = criterion(sup_predicted_locs, sup_predicted_scores, sup_boxes, sup_labels) 
