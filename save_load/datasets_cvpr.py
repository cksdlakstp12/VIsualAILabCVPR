...
class KAISTPed(data.Dataset):
    ...
    def __init__(self, args, condition='train'):
        ...
        self.annotations = {}
        anno_name = "../cvpr/new_annotations2.txt"
        with open("../cvpr/90percents.txt", "r") as f:
            for line in f:
                id = line.strip()
                self.annotations[id] = []
        print("annotations : ", anno_name)
    ...
    def __getitem__(self, index):
        ...
        #img_path = '/'.join(self.ids[index][-1])  # Assuming the ids have the image path components
