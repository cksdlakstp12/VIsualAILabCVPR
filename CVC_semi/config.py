...
# Soft Teacher
soft_teacher = edict()
soft_teacher.student_checkpoint = "../teacher_weights.pth.tar071"
...
# train.U_img_set = "l_fast_test.txt"
# train.L_img_set = "u_fast_test.txt"
...
args.dataset_type = "KAIST" # KAIST or CVC14
...
ema.tau = 0 # it also be start_tau when using scheduler
