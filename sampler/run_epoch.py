...
def softTeaching_every_iter(s_model: SSD300,
    ...
    # Batches
    for (batch_idx_L, (wL_image_vis, wL_image_lwir, sL_image_vis, sL_image_lwir, L_vis_box, L_lwir_box, L_vis_labels, L_lwir_labels, _, L_is_anno)), (batch_idx_U, (wU_image_vis, wU_image_lwir, sU_image_vis, sU_image_lwir, U_vis_box, U_lwir_box, U_vis_labels, U_lwir_labels, _, U_is_anno)) in zip(enumerate(L_dataloader), enumerate(U_dataloader)):
